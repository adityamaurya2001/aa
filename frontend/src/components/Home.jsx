...
const Homes = () => {
  ...
  const handleAddToCart = async (id) => {
    try {
      await orderService.addToCart({ productId: id, quantity: 1 });
      toast.success("Added to cart 🛒");
      window.dispatchEvent(new Event("cartUpdated"));
    } catch {
  ...
  return (
    <div className="bg-gray-50">
      ...
      <section className="relative h-[80vh] bg-cover bg-center flex items-center"
        style={{
          backgroundImage:
            "url('https://images.unsplash.com/photo-1501004318641-b39e6451bec6?auto=format&fit=crop&w=2000&q=100')",
        }}
      >
        ...
        <div className="relative container mx-auto px-6 text-white max-w-2xl">
          <h1 className="text-5xl font-bold leading-tight">
            Fresh Flowers <br /> Delivered With Love
          </h1>
          <p className="mt-6 text-lg">
            Discover premium bouquets crafted with elegance and care.
          </p>

          <Link
            to="/products"
            className="inline-flex items-center mt-8 bg-pink-600 px-8 py-4 rounded-full font-semibold hover:bg-pink-700 transition"
          >
      ...
      <section className="py-16 container mx-auto px-4 grid md:grid-cols-3 gap-8 text-center">
        <div className="bg-white p-8 rounded-xl shadow">
          <Truck className="mx-auto text-pink-600 mb-4" size={40} />
        ...
        <div className="bg-white p-8 rounded-xl shadow">
          ...
          <h3 className="font-bold text-lg">Fresh Guarantee</h3>
          <p className="text-gray-500">7 days freshness</p>
        </div>

        <div className="bg-white p-8 rounded-xl shadow">
          <Sparkles className="mx-auto text-pink-600 mb-4" size={40} />
          <h3 className="font-bold text-lg">Premium Quality</h3>
          <p className="text-gray-500">Handcrafted bouquets</p>
        </div>
      </section>
      ...
      <section className="py-20 bg-pink-600 text-white text-center">
        ...
        <p className="mb-8">Get 15% off your first order 🌸</p>

        <div className="flex justify-center">
          <input
            type="email"
            placeholder="Your email"
            className="px-6 py-4 rounded-l-full text-black outline-none"
          />
          <button
            onClick={() => toast.success("Subscribed 🎉")}
            className="bg-black px-6 py-4 rounded-r-full font-semibold"
          >
            Subscribe
          </button>
        </div>
